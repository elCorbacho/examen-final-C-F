...
<div class="container">
    ...
    <form method="POST" action="{{ route('productos.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="descripcion_corta" name="descripcion_corta" value="{{ old('descripcion_corta') }}">
        </div>
        <div class="mb-3">
            <label for="descripcion_larga" class="form-label">Descripción larga</label>
            <textarea class="form-control" id="descripcion_larga" name="descripcion_larga">{{ old('descripcion_larga') }}</textarea>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="precio_con_iva" name="precio_con_iva" value="{{ old('precio_con_iva') }}" required>
        </div>
        <div class="mb-3">
